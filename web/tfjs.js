...
// let extra="models/abcd_leave_out_site01_tfjs_64"; 
// let extra="models/abcd_leave_out_site01_tfjs_256"; 
// let extra="models/modeljs_savemodel_5"
let extra="models/modeljs_savemodel_13"
...
let run_tf_module=async function(img) {
    ...
    const URL=getScope()+extra; // model selection url points to model on bioimage github
